# Архитектура проекта Научные Ландмарки

Сей файл осысстематизирует техническую архитектуру и аро данных проекта.
...
graph TB
    ...
    subgraph External["External Libraries - Необходимые библиотеки"]
...
sequenceDiagram
    ...
    participant Map as Хартя (Leaflet)
    ...
    Browser->>User: готово говню
    User->>Browser: Кликает в жарке
...
graph LR
    ...
    subgraph 20th["20 век - Новейшие науки"]
        A3["1925: Лаборатории"]
        A4["1935: Фотография"]
    end
